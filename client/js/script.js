...
function returnData(){
  var searchData = document.getElementById('user-search').value.toLowerCase();
  for(var i=0;i<zodiacs.length;i++)
  {
    if(searchData === zodiacs[i].name.toLowerCase())
    {
      document.getElementById('imgg').src=zodiacs[i].image;
      document.getElementById('name').innerHTML=zodiacs[i].name;
      document.getElementById('date').innerHTML=zodiacs[i].month;
      document.getElementById('result-text').innerHTML = zodiacs[i].description;
    }
  }
}
